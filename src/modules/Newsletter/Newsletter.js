...
class Newsletter {
  ...
  buildNewsletterInnerWrapper = () => {
    ...
    $newsInnerWrapper.className = [styles.news_inner_wrapper, 'd-flex', 'just-content-space-between', 'align-items-center'].join(' ');
  ...
  buildTextContainer = () => {
    ...
    $textContainer.className = [styles.text_container, 'd-flex', 'flex-direction-column', 'just-content-center'].join(' ');
  ...
  buildImgWrapper = () => {
    ...
    $img_newsletter.className = [styles.img_newsletter, 'wd-40'].join(' ');
